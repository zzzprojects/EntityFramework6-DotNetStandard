        ...
        public class RegisterSingleton
        {
            ...
            public void Adds_a_singleton_resolver()
            {
                ...
                new InternalConfiguration(
                    ...
                    new RootDependencyResolver()).RegisterSingleton(new object());
            ...
            public void Adds_a_singleton_resolver_with_a_key()
            {
                ...
                new InternalConfiguration(
                    ...
                    new RootDependencyResolver()).RegisterSingleton("Bilbo", "Baggins");
            ...
            public void Adds_a_singleton_resolver_with_a_key_predicate()
            {
                ...
                new InternalConfiguration(
                    new Mock<ResolverChain>().Object, normalChain,
                    new RootDependencyResolver()).RegisterSingleton("Bilbo", k => ((string)k).StartsWith("B"));
        ...
        public class AddDefaultResolver
        {
            ...
            public void AddDefaultResolver_adds_a_default_resolver_to_the_root()
            {
                ...
                new InternalConfiguration(
                    ...
                    new Mock<ResolverChain>().Object,
                    mockRootResolver.Object).AddDefaultResolver(resolver);
        ...
        public class SetDefaultProviderServices
        {
            ...
            public void SetDefaultProviderServices_sets_the_default_provider_on_the_root()
            {
                ...
                new InternalConfiguration(
                    new Mock<ResolverChain>().Object,
                    new Mock<ResolverChain>().Object,
                    mockRootResolver.Object).SetDefaultProviderServices(provider, "My.Provider");
            ...
            public void ResolverSnapshot_returns_resolvers_in_correct_order()
            {
                ...
                var configuration = new DbConfiguration(
                    new InternalConfiguration(
                        configChain,
                        new ResolverChain(),
                        rootResolver.Object)).InternalConfiguration;
